...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "ninja", name: "옥상 닌자", description: "루프탑 러너 골인.", emoji: "🐱", reward: 150, check: (_, last) => last.mode === "GOGUN" && last.finished },
...
export const MISSION_POOL: MissionDef[] = [
  ...
  { id: "gogun_300", name: "루프탑 러너 300 m 달리기", target: 300, reward: 120, emoji: "🐱", progress: (l) => (l.mode === "GOGUN" ? Math.floor(l.distance ?? 0) : 0) },
